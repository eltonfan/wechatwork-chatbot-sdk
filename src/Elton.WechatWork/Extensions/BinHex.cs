...
namespace Elton.WechatWork
{
    ...
    /// from/to hex
    /// 
    /// https://www.codeproject.com/Tips/447938/%2FTips%2F447938%2FHigh-performance-Csharp-byte-array-to-hex-string-t
    /// </summary>
    public static unsafe class BinHex
    {
        // assigned int values for bytes (0-255)
        private static readonly int[] toHexTable = new int[] {
        ...
        private static readonly byte[] fromHexTable = new byte[] {
        ...
        private static readonly byte[] fromHexTable16 = new byte[] {
            255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
        ...
        public static string ToBinHex(this byte[] source)
        {
            return ToHexString(source, false);
        }

        public static byte[] AsBinHexBytes(this string source)
        {
